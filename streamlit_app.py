...
fruits_list = pd.read_table("https://uni-lab-files.s3.us-west-2.amazonaws.com/dabw/fruit_macros.txt",sep=",",index_col="fruits")

streamlit.multiselect("SELECT SOME FRUITS", list(fruits_list))
